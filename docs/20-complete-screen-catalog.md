...
| Navigation | → Trade → Deposit → Withdraw → Earn → Wallet |
...
### 17. Wallet Screen (Main)

| Property | Value |
|----------|-------|
| Screen Name | WalletFragment |
...
| Navigation | → 2FA Verification → Wallet |
